...
\begin{document}
	...
	\begin{figure}
		...
		\caption{Ricerca in ampiezza - implementazione in Java}
	\end{figure}
	\newpage
	...
	Quindi escuderemo dalla ricerca i nodi adiacenti che non contengono questi 3 caratteri.\\
	...
	\end{tabular}
	\begin{figure}
		\includegraphics[height=0.6\textheight]{bfsTrie}
		\caption{Ricerca in ampiezza con Trie - implementazione in Java}
	\end{figure}
	\newpage
	\subsection{Ricerca in profondità con Trie}
	Non vogliamo dilungarci troppo su quest'algoritmo dato che è figlio della ricerca in profondità, quindi mantiene le sue caratteristiche già descritte. Alla rcierca vengono aggiunte le funzionalità del Trie, già descritte nel paragrafo precedente.
