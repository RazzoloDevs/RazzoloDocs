...
\begin{document}
	...
	Non vogliamo dilungarci troppo su quest'algoritmo dato che è figlio della ricerca in profondità, quindi mantiene le sue caratteristiche già descritte. Alla ricerca vengono aggiunte le funzionalità del Trie, già descritte nel paragrafo precedente.
